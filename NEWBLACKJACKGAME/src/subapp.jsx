...
// ########################################################
 ...
 // FULLY WORKING LLM GAME WITH SAFE AND AGGRESSIVE PLAYSTYLES
...
// START OF GAME WITH 3 PLAYSTYLES
...
// GAME BEFORE BEST MOVE FOR PLAYER 1
...
//                 <div style={{ color: '#a78bfa', fontSize: '20px', fontWeight: 'bold', marginBottom: '12px' }}>💎 Side Bets</div>
//                 <div style={{ color: '#fcd34d', fontSize: '14px', marginBottom: '16px' }}>
//                   Pair: Same rank pays 5:1 | Suited pair pays 20:1
//                 </div>
//                 {pairBet === 0 ? (
//                   <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
//                     <button onClick={() => placePairBet(5)} disabled={players[0].chips < 5} style={{ padding: '10px 20px', borderRadius: '8px', fontWeight: 'bold', fontSize: '14px', color: 'white', background: players[0].chips < 5 ? 'rgba(139, 92, 246, 0.3)' : 'linear-gradient(180deg, #8b5cf6 0%, #7c3aed 100%)', border: '2px solid rgba(255,255,255,0.3)', cursor: players[0].chips < 5 ? 'not-allowed' : 'pointer', opacity: players[0].chips < 5 ? 0.5 : 1 }}>Pair $5</button>
//                     <button onClick={() => placePairBet(10)} disabled={players[0].chips < 10} style={{ padding: '10px 20px', borderRadius: '8px', fontWeight: 'bold', fontSize: '14px', color: 'white', background: players[0].chips < 10 ? 'rgba(139, 92, 246, 0.3)' : 'linear-gradient(180deg, #8b5cf6 0%, #7c3aed 100%)', border: '2px solid rgba(255,255,255,0.3)', cursor: players[0].chips < 10 ? 'not-allowed' : 'pointer', opacity: players[0].chips < 10 ? 0.5 : 1 }}>Pair $10</button>
//                     <button onClick={() => placePairBet(25)} disabled={players[0].chips < 25} style={{ padding: '10px 20px', borderRadius: '8px', fontWeight: 'bold', fontSize: '14px', color: 'white', background: players[0].chips < 25 ? 'rgba(139, 92, 246, 0.3)' : 'linear-gradient(180deg, #8b5cf6 0%, #7c3aed 100%)', border: '2px solid rgba(255,255,255,0.3)', cursor: players[0].chips < 25 ? 'not-allowed' : 'pointer', opacity: players[0].chips < 25 ? 0.5 : 1 }}>Pair $25</button>
//                   </div>
//                 ) : (
...
//           {gameState === 'playing' && pairBetOutcome && (
//             <div style={{ marginTop: '24px', textAlign: 'center' }}>
//               <div style={{ display: 'inline-block', background: pairBetOutcome.won ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)', border: pairBetOutcome.won ? '2px solid #22c55e' : '2px solid #ef4444', borderRadius: '12px', padding: '16px 24px' }}>
//                 <div style={{ color: pairBetOutcome.won ? '#22c55e' : '#ef4444', fontSize: '18px', fontWeight: 'bold', marginBottom: '8px' }}>
//                   {pairBetOutcome.won ? '🎉 Pair Bet WON!' : '❌ Pair Bet Lost'}
//                 </div>
//                 <div style={{ color: '#fcd34d', fontSize: '14px' }}>
//                   {pairBetOutcome.type}
//                   {pairBetOutcome.won && ` - Won $${pairBetOutcome.payout}`}
//                 </div>
//               </div>
//             </div>
//           )}
